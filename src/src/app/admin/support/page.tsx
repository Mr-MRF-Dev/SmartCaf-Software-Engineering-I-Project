...
export default function AdminSupportPage() {
  ...
  const resolvedToday = mockTickets.filter(
    (t) => t.status === "resolved",
  ).length;

  const criticalIssues = mockSoftwareIssues.filter(
    (i) => i.priority === "critical",
  ).length;
  const highIssues = mockSoftwareIssues.filter(
    (i) => i.priority === "high",
  ).length;
    ...
    switch (priority) {
      ...
      case "critical":
        return (
          <Badge
            variant="destructive"
            className="bg-red-600 dark:bg-red-900 text-white dark:text-red-100"
          >
            فوری
          </Badge>
        );
    ...
    switch (type) {
      case "bug":
        return (
          <Badge
            variant="outline"
            className="bg-red-50 dark:bg-red-950 text-red-700 dark:text-red-300 border-red-200 dark:border-red-800 flex items-center gap-1 w-fit"
          >
      ...
      case "feature":
        return (
          <Badge
            variant="outline"
            className="bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800 flex items-center gap-1 w-fit"
          >
      ...
      case "improvement":
        return (
          <Badge
            variant="outline"
            className="bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800 flex items-center gap-1 w-fit"
          >
      ...
      case "question":
        return (
          <Badge
            variant="outline"
            className="bg-purple-50 dark:bg-purple-950 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-800 flex items-center gap-1 w-fit"
          >
  ...
  return (
    <div className="container py-8 px-4" dir="rtl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
          مرکز پشتیبانی
        </h1>
        <p className="text-gray-600 dark:text-gray-400">
          مدیریت تیکت‌های دانشجویان و پشتیبانی نرم‌افزار
        </p>
      </div>

      <Tabs defaultValue="student-support" className="space-y-6">
        <TabsList className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 mx-auto">
          <TabsTrigger
            value="student-support"
            className="data-[state=active]:bg-slate-900 data-[state=active]:text-white dark:data-[state=active]:bg-slate-700"
          >
          ...
          <TabsTrigger
            ...
            className="data-[state=active]:bg-blue-950 data-[state=active]:text-white dark:data-[state=active]:bg-blue-800"
          >
        ...
        {/* Student Support Tab */}
        <TabsContent value="student-support" className="space-y-6" dir="rtl">
          {/* Stats */}
          ...
          <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                >
                  <SelectTrigger className="w-[180px] bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-right">
                    ...
                    >
                      ...
                      <TableCell>
                        <Dialog>
                          ...
                          <DialogContent
                            className="max-w-3xl bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800 max-h-[80vh] overflow-y-auto"
                            dir="rtl"
                          >
                            <DialogHeader>
                                          ...
                                          <div>
                                            <p className="text-sm font-semibold text-gray-900 dark:text-white">
                                              ...
                                              {response.userRole ===
                                                ...
                                                <Badge
                                                  variant="outline"
                                                  className="mr-2 text-xs bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800"
                                                >
                                                  پشتیبان
                                                </Badge>
                                              )}
                                ...
                                <>
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <Textarea
                                      ...
                                      rows={4}
                                      dir="rtl"
                                      className="bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white resize-none text-right"
                                    />
                                    <div className="flex gap-2">
                                      ...
                                      >
                                        <SelectTrigger className="w-[200px] bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-right">
        ...
        <TabsContent value="software-support" className="space-y-6" dir="rtl">
          {/* Stats */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
              <CardHeader>
                ...
                <CardDescription className="text-gray-600 dark:text-gray-400">
                  ارسال باگ یا درخواست ویژگی جدید
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select dir="rtl">
                      <SelectTrigger className="bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-right">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select dir="rtl" defaultValue={currentVersion?.version}>
                      <SelectTrigger className="bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-right">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      dir="rtl"
                      className="bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-right"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-400">
                    پیگیری مشکلات و درخواست‌های ارسال شده به شرکت
                  </CardDescription>
                </div>
                <Select
                  dir="rtl"
