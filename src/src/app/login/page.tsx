...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-bl from-emerald-50 via-white to-emerald-50 flex items-center justify-center p-4">
          ...
          <CardContent>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              ...
              <p className="text-xs text-gray-400 text-center mt-1">
                برای ورود به عنوان مدیر: نام کاربری <span className="font-mono bg-gray-100 px-1 rounded">admin</span> و رمز <span className="font-mono bg-gray-100 px-1 rounded">admin</span>
              </p>
            </div>
          </CardContent>
        </Card>
