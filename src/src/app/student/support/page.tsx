    ...
    <div className="container py-8 px-4">
      ...
      <Card className="mb-6 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
        <CardHeader className="border-b border-gray-200 dark:border-gray-800">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400">
            در صورت نیاز به پشتیبانی فوری با ما تماس بگیرید
          </CardDescription>
        </CardHeader>
      ...
      <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
        <CardHeader className="border-b border-gray-200 dark:border-gray-800">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400">
            لیست درخواست‌ها و تیکت‌های شما
          </CardDescription>
        </CardHeader>
        <CardContent>
                                  ...
                                  <div>
                                    <p className="text-sm font-semibold text-gray-900 dark:text-white">
                                      ...
                                      {response.userRole === "admin" && (
                                        <Badge
                                          variant="outline"
                                          className="mr-2 text-xs bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800"
                                        >
                                          پشتیبانی
                                        </Badge>
                                      )}
